...
def arg_parser():
	...
	parser.add_argument('--seed', metavar = 'SE', type = int, default = 4321, help = 'random seed number for inference, reproducibility')
	parser.add_argument('-n', '--n_customer', metavar = 'N', type = int, default = 50, help = 'number of customer nodes, time sequence')

	# train config
	parser.add_argument('-b', '--batch', metavar = 'B', type = int, default = 192, help = 'batch size')
	parser.add_argument('-bs', '--batch_steps', metavar = 'BS', type = int, default = 534, help = 'number of samples = batch * batch_steps')
	parser.add_argument('-bv', '--batch_verbose', metavar = 'BV', type = int, default = 10, help = 'print and logging during training process')
	parser.add_argument('-nr', '--n_rollout_samples', metavar = 'R', type = int, default = 12800, help = 'baseline rollout number of samples')
	parser.add_argument('-e', '--epochs', metavar = 'E', type = int, default = 300, help = 'total number of samples = epochs * number of samples')
